...
export default function buildAHorse(num) {
    const horseParts = {
        ...
        eye: function() {
            let eyeColor = color === 'white' ? 'black' : 'white';
        ...
        nostril: function() {
            let nostrilColor = color === 'white' ? 'black' : 'white';
        ...
        hair: function(hairColor, hairType) {
            const hairTypes = [
            ...
            return `<path style="stroke-width: 4px; stroke: ${color === 'white' ? 'black' : 'white'}; fill: ${hairColor}" ${hairTypes[hairType]}></path>`;
        },
        base: function() {
